...
import { ProjectMetrics, ProjectTechnology } from './project-secondary-info';
...
export function Article({ project, loadSecondaryData = false }: ArticleProps) {
    ...
    <article className="p-4">
      <div className="flex items-center justify-between gap-2">
        <time
          dateTime={createdAt}
          title="Created"
          className="drop-shadow-orange text-xs text-zinc-200 duration-1000 group-hover:border-zinc-200 group-hover:text-white"
        >
      ...
      <div className="border-opacity-50 mt-2 flex items-center justify-between gap-2 border-t-2 border-gray-700">
        {loadSecondaryData ? (
        ...
        <span
          className="flex max-w-[38%] min-w-0 items-center gap-1 text-xs text-zinc-500"
