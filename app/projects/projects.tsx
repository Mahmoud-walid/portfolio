...
function ProjectCard({ project, loadSecondaryData }: ProjectCardProps) {
  return (
    <Card>
      <Article project={project} loadSecondaryData={loadSecondaryData} />
    </Card>
  );
}
...
export default async function ProjectsComponent({
  ...
  const { heroes, sorted, isPortfolioOwner } =
